...
const MovieDetails = ({ movie, onClose }: MovieDetailsProps) => {
  ...
  return (
    <div onClick={onBlur} className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 pt-20" data-testid="movie-details-modal">
